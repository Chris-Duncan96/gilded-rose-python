from item import Item, Sulfuras, ImprovingProduct
...
class GildedRoseTest(TestCase):
    ...
    def test_quality_goes_up_for_improving_products(self):
        self.items.append(ImprovingProduct("Aged Brie", 20, 30))
        self.items.append(ImprovingProduct("Backstage passes to a TAFKAL80ETC concert", 20, 30))
        gilded_rose.update_quality(self.items)
        expected = [
    ...
    def test_quality_goes_up_by_two_for_improving_products_with_10_days_or_less_left(self):
        self.items.append(ImprovingProduct("Aged Brie", 10, 34))
        self.items.append(ImprovingProduct("Backstage passes to a TAFKAL80ETC concert", 8, 30))
        gilded_rose.update_quality(self.items)
        expected = [
    ...
    def test_quality_goes_up_by_three_for_improving_products_with_5_days_or_less_left(self):
        self.items.append(ImprovingProduct("Aged Brie", 4, 11))
        self.items.append(ImprovingProduct("Backstage passes to a TAFKAL80ETC concert", 5, 15))
        gilded_rose.update_quality(self.items)
        expected = [
    ...
    def test_ImprovingProducts_go_to_quality_zero_after_sell_by(self):
        self.items.append(ImprovingProduct("Aged Brie", 0, 20))
        self.items.append(ImprovingProduct("Backstage passes to a TAFKAL80ETC concert", 0, 20))
        gilded_rose.update_quality(self.items)
        expected = [
            {'sell_in': -1, 'quality': 0},
            {'sell_in': -1, 'quality': 0},
    ...
    def test_sulfuras_the_immutable(self):
        self.items.append(Sulfuras(0, 80))
        gilded_rose.update_quality(self.items)
    ...
    def test_quality_does_not_increase_past_50(self):
        self.items.append(ImprovingProduct("Aged Brie", 4, 49))
        gilded_rose.update_quality(self.items)
